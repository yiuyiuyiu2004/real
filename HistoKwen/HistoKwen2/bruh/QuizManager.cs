    ...
    public bool Answer(string selectedOption)
    {
        ...
        else
        {
            ...
            void ShowPanel2()
            {
                ...
                StartCoroutine(WaitAndClosePanel2());
            }

            IEnumerator WaitAndClosePanel2()
            {
            yield return new WaitForSeconds(1f);
            ClosePanel2();
            }
...
[System.Serializable]
public enum QuestionType //to pick which one u want for the game like images or text and etc
{
    TEXT,
    IMAGE,
    AUDIO,
